    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File fin = new File("C:/Users/Juan Rodriguez/Desktop/mailingAZ.csv");
	        FileInputStream fis = new FileInputStream(fin);

	        String[][] values = new String[471][3];
	    	...
	    	for(i = 0; i < Math.min(2000,values.length); i++) {
	    		...
	    		if(set.next()) {
		    		...
		    		if(send) {
		    			System.out.println(email+";"+firstname+";"+lastname+";"+login+";"+password+";1");
		    			index++;
	/*	    			String subject;
			    		MailSender sender;
		...
		/*	        				if(emailCopy != null && emailCopy.length() > 0 && !emailCopy.equals("---")) {
		    			...
		    			System.out.println(email+";"+firstname+";"+lastname+";"+login+";"+password+";0");
		    		}
	    		}else {
	    			System.out.println(login);	
	    		}
