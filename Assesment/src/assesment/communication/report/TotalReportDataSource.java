...
public class TotalReportDataSource implements JRDataSource {
    ...
    public TotalReportDataSource(Integer correctas, Integer incorrectas, Text messages) {
        ...
        if(correctas == 0 && incorrectas == 0) {
        	...
        	porcentaje_correctas = Math.round(correctas * 100 / (correctas + incorrectas));
