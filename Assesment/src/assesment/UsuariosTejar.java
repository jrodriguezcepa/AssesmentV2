...
public class UsuariosTejar {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File fin = new File("C:/Users/Juan Rodriguez/Desktop/eltejar.csv");
	        FileInputStream fis = new FileInputStream(fin);
	
	        String[][] values = new String[129][4];
	        ...
	        File f = new File("C:/Users/Juan Rodriguez/Desktop/eltejar.sql");
	        ...
	        File f2 = new File("C:/Users/Juan Rodriguez/Desktop/eltejar_users.csv");
	    	...
	    	for(i = 0; i < Math.min(1000,values.length); i++) {
	    		...
	    		String login = tokenizer.nextToken().toLowerCase()+".eltejar";
    			...
    			String insert = "INSERT INTO users (loginname, password, firstname, lastname, email, language, role, country, nationality,vehicle) " +
    					"VALUES ('"+login+"','"+md5.encriptar(password)+"','"+firstName+"','"+lastName+"','"+email+"','es','systemacces',33,33,'"+vehicle+"');\n";
    			fos.write(insert.getBytes());
    			insert = "INSERT INTO userassesments(assesment,loginname) VALUES (95,'"+login+"');\n";
    			fos.write(insert.getBytes());
