...
public class UsuariosJanssen {
    ...
    public static void main(String[] args) {
        ...
        try {
	        ...
	        File f = new File("C://MonsantoLANUsers.sql");
	        ...
	        MD5 md5 = new MD5();
	        int index = 1;
	    	for(i = 0; i < Math.min(100,values.length); i++) {
		        	...
		        	while(!done) {
		                try {
			        		...
			        		if(!doneUsers.contains(login)) {
			        			...
			        			String insert = "INSERT INTO users (loginname,firstname,lastname,language,email,password,role) VALUES ('"+login+"','"+firstName.trim()+"','"+lastName.trim()+"','pt','"+email+"','"+password+"','systemaccess');\n";
