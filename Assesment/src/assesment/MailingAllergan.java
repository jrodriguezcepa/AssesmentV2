    ...
    public static void main(String[] args) {
		...
		try {
            ...
            ResultSet setDone = st.executeQuery("SELECT ua.loginname " +
            		...
            		" AND uas.psitestid is not null "+
            		"GROUP BY ua.loginname " +
            		"HAVING count(*) = 77"); // Cantidad de usuarios en el assessment
            while(setDone.next()) {
            	doneUsers.add(setDone.getString("loginname"));
            }

            MD5 md5 = new MD5();
	    	for(int i = 0; i < Math.min(4000,users.length); i++) {
...
//	        			email = "federico.millan@cepasafedrive.com"; 
		        		...
		        		if(!doneUsers.contains(login)) {
		        			...
		        			// Asunto
		        			mensaje.setSubject("Último dia para realizar o 'Driver Assessment'");
		        			// Emisor del mensaje
		        			...
		        			imagen.attachFile(AssesmentData.FLASH_PATH+"/images/header_allergan.jpg");
	...
	private static String getMail(String href) {
		String mail = "<html>" +
			...
			"						Em linha com o comunicado enviado ontem pela <b>Allergan</b>, disponibilizamos a seguir seu acesso para a ferramenta &ldquo;Driver Assessment&rdquo;." +
			"						<br/><br/>"+
			"						O t&eacute;rmino desta atividade est&aacute; previsto para <b>05/abril/2010</b>. Por favor, responda todos os question&aacute;rios at&eacute; esta data para receber o relat&oacute;rio de desempenho."+
			"						<br/><br/>"+
			...
			"					<span style=\"font-size: 10pt; font-family: &quot;Verdana&quot;,&quot;sans-serif&quot;; color: rgb(102, 102, 102);\">" +
			"						<br/><br/>"+			
			"						Agradecemos sua participa&ccedil;&atilde;o.<br/>"+
			"						Sua contribui&ccedil;&atilde;o ser&aacute; muito valiosa e contamos com ela!"+
			"						<br/><br/>"+
			"						Em caso de d&uacute;vidas ou consultas, favor entrar em contato com:  <a class=\"moz-txt-link-freetext\" href=\"mailto:indesa@cepasafedrive.com\">indesa@cepasafedrive.com</a>"+
			"					</span>" +
			"					<br>" +
			"					<br>" +
			"					<br>" +
