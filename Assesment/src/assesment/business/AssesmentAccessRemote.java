...
public class AssesmentAccessRemote { 

	private static final long serialVersionUID = 1L;
	/**
	 * Logger for this class
	 */
	private Logger logger = Logger.getLogger(AssesmentAccessRemote.class);
	private LoggerFormatting logFormatting=new LoggerFormatting();
	
	private ExceptionHandler handler = new ExceptionHandler(AssesmentAccessRemote.class);
	...
	private boolean horizontalAccess;
	 ...
	 * @throws Exception
	 */
    public AssesmentAccessRemote(String user, Hashtable ev) throws Exception {
    	this.environment=ev;
    	this.environment.put(Context.INITIAL_CONTEXT_FACTORY, "org.jboss.security.jndi.LoginInitialContextFactory");  
    	this.environment.put(Context.URL_PKG_PREFIXES, "org.jboss.naming:org.jnp.interfaces");  
    	this.environment.put(Context.SECURITY_PROTOCOL, "assesment");  
        try {
	...
	public void setHorizontalAccess(boolean horizontalAccess) {
		this.horizontalAccess = horizontalAccess;
	}
	...
	public UsABMFacade getUserABMFacade() throws DCSecurityException, DeslogedException, CommunicationProblemException {
		...
		try {
			UsABMFacadeHome home = UsABMFacadeUtil.getHome(environment);			
	...
	public UsReportFacade getUserReportFacade() throws DCSecurityException, DeslogedException, CommunicationProblemException {
		...
		try {
			...
			UsReportFacadeHome home = UsReportFacadeUtil.getHome(environment);
	...
	public CorpABMFacade getCorporationABMFacade()
		...
		try {
			CorpABMFacadeHome home = CorpABMFacadeUtil.getHome(environment);
	...
	public CorpReportFacade getCorporationReportFacade()
		...
		try {
			CorpReportFacadeHome home = CorpReportFacadeUtil.getHome(environment);
    ...
    public AssesmentABMFacade getAssesmentABMFacade() throws Exception {
        ...
        try {
            AssesmentABMFacadeHome home = AssesmentABMFacadeUtil.getHome(environment);
    ...
    public AssesmentReportFacade getAssesmentReportFacade() throws Exception {
        ...
        try {
            AssesmentReportFacadeHome home = AssesmentReportFacadeUtil.getHome(environment);
    ...
    public LangReportFacade getLanguageReportFacade() throws Exception {
        ...
        try {
            LangReportFacadeHome home = LangReportFacadeUtil.getHome(environment);
    ...
    public LangABMFacade getLanguageABMFacade() throws Exception {
        ...
        try {
            LangABMFacadeHome home = LangABMFacadeUtil.getHome(environment);
    ...
    public ModuleABMFacade getModuleABMFacade() throws Exception {
        ...
        try {
            ModuleABMFacadeHome home = ModuleABMFacadeUtil.getHome(environment);
    ...
    public ModuleReportFacade getModuleReportFacade() throws Exception {
        ...
        try {
            ModuleReportFacadeHome home = ModuleReportFacadeUtil.getHome(environment);
    ...
    public QuestionABMFacade getQuestionABMFacade() throws Exception {
        ...
        try {
            QuestionABMFacadeHome home = QuestionABMFacadeUtil.getHome(environment);
    ...
    public QuestionReportFacade getQuestionReportFacade() throws Exception {
        ...
        try {
            QuestionReportFacadeHome home = QuestionReportFacadeUtil.getHome(environment);
    ...
    public TagReportFacade getTagReportFacade() throws Exception {
        ...
        try {
            TagReportFacadeHome home = TagReportFacadeUtil.getHome(environment);
    ...
    public TagABMFacade getTagABMFacade() throws Exception {
        ...
        try {
            TagABMFacadeHome home = TagABMFacadeUtil.getHome(environment);
	...
	public PropertyReportFacade getPropertyReportFacade() throws Exception{
        ...
        try {
            PropertyReportFacadeHome home = PropertyReportFacadeUtil.getHome(environment);
	...
	public PropertyABMFacade getPropertyABMFacade() throws Exception{
        ...
        try {
            PropertyABMFacadeHome home = PropertyABMFacadeUtil.getHome(environment);
