...
/**
 * Clase que mapea el archivo de pagos de Abitab.
 * 
 * @author gbenaderet
 *
 */
public class AbitabPayment {
	...
	private int agencia; // Numérico 3
	private int subAgencia; //Numerico 3
	...
	/**
	 * @return the subagencia
	 */
	public int getSubAgencia() {
		return subAgencia;
	}

	/**
	 * @param subagencia the subagencia to set
	 */
	public void setSubAgencia(int subAgencia) {
		this.subAgencia = subAgencia;
	}

	public AbitabPayment(String codigoEmpresa, int lote,
