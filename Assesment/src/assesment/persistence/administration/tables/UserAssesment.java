...
public class UserAssesment implements Serializable {
	...
	public UserAssesment(User user,Assesment assesment)
	throws HibernateException{
		this.pk=new UserAssesmentPK(user,assesment);		
	}
	
	public UserAssesment(String user, Integer assesmentId) {
		this.pk=new UserAssesmentPK(user,assesmentId);		
	}
	...
	public boolean equals(Object arg0) {
		UserAssesment userCorporation=(UserAssesment)arg0;
		String userId1=this.pk.getUser().getLoginName();
		String userId2=userCorporation.getPk().getUser().getLoginName();
		Integer assesmentId1=this.pk.getAssesment().getId();
		Integer assesmentId2=userCorporation.getPk().getAssesment().getId();
		if(userId1.equals(userId2) && assesmentId1.equals(assesmentId2)){
			return true;
		}
		else{
			return false;
