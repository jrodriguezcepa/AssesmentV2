...
public abstract class QuestionReportBean implements SessionBean {
    ...
    */
     ...
     * @ejb.permission role-name = "administrator,clientreporter,cepareporter,systemaccess"
     */
    public Collection getQuestionReportByDivision(Integer assessment,String division, UserSessionData userSessionData) throws Exception {
    	try {
            ...
            handler.getException(e,"getQuestionReportByDivision",userSessionData.getFilter().getLoginName());
		}
    	return null;
    }
}