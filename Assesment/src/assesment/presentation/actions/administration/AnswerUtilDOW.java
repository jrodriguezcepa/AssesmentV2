...
public class AnswerUtilDOW extends AnswerUtil {

    public AnswerUtilDOW() {
        super();
    }
...
*/
  ...
  //          body += "<tr><td> - Certificado</td><tr>";
            ...
            String title = messages.getText("assessment.reports")+" - DOW - "+name;

            send(sender,user.getEmail(),messages,body,name,title,files,AssesmentData.FLASH_PATH+"/images/logos_cepa_dow.jpg","logo.jpg");
            ...
            while(it.hasNext()) {
                ...
                send(sender,feedback.getEmail(),messages,body,name,title,files,AssesmentData.FLASH_PATH+"/images/logos_cepa_dow.jpg","logo.jpg");
            }
        }
    }
    ...
    public void resend(AssesmentAccess sys,AssesmentAttributes assesment, String login, String email) throws Exception {
        ...
        String title = messages.getText("assessment.reports")+" - DOW - "+name;
        sendEmail(user,assesment,sys,body,title,email,files,AssesmentData.FLASH_PATH+"/images/logos_cepa_dow.jpg");
    }
