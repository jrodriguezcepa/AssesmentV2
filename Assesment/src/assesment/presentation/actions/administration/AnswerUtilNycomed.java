...
public class AnswerUtilNycomed extends AnswerUtil {

    public AnswerUtilNycomed() {
        super();
    }
    ...
    public void feedback(AssesmentAccess sys,AssesmentAttributes assesment) throws Exception {
        ...
        if(userReport.isAssessmentDone(login,assesment.getId(),userSessionData,assesment.isPsitest())) {
            ...
            String fileName = AssesmentData.FLASH_PATH+"/reports/resultado_Nycomed_"+name+".pdf";
            ...
            fileName = AssesmentData.FLASH_PATH+"/reports/errores_Nycomed_"+name+".pdf";
            ...
            fileName = AssesmentData.FLASH_PATH+"/reports/comportamiento_Nycomed_"+name+".pdf";
            util.createPsiReport(sys,fileName,assesment,user.getLoginName());
            body += "<tr><td> - "+messages.getText("report.feedback.psireport")+"</td><tr>";
            files.add(fileName);
            
        	fileName = AssesmentData.FLASH_PATH+"/reports/certificate_Nycomed_"+name+".pdf";
            ...
            body += "<tr><th align='left'>Muito obrigado, sua contribui&ccedil;&atilde;o foi muito valiosa. Anexo, seguem seus reportes.</th></tr>";
            body += "</table></td></tr>";
            body += "</table>";
            
            String title = messages.getText("assessment.reports")+" - Nycomed - "+name;
