 ...
 */
public class CategoryAssessmentDeleteAction extends AbstractAction {
    ...
    public ActionForward action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        assessmentABM.desasociateAssesmentCategory(new Integer(categoryForm.getId()), assessments, sys.getUserSessionData());

        session.removeAttribute("CategoryAssessmentDeleteForm");
        session.setAttribute("category",categoryForm.getId());
        return mapping.findForward("next");
    }
}