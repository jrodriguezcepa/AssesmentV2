 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class CorporationDeleteAction extends AbstractAction {
	...
	public ActionForward action(ActionMapping mapping, ActionForm form,HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        DynaActionForm corporationDeleteForm = (DynaActionForm) form;
        try {
            UserSessionData userSessionData = sys.getUserSessionData();
    		String ids = corporationDeleteForm.getString("corporation");
            Collection list = Util.stringToCollection(ids);
    			
    		CorpABMFacade corporationABM = sys.getCorporationABMFacade();
    		corporationABM.delete(list,userSessionData);
            ...
            if (thw instanceof InvalidDataException) {
                ...
                if(corporationDeleteForm.getString("target").equals("list")) {
                    return mapping.findForward("list");
                }else {
                    session.setAttribute("corporation",corporationDeleteForm.getString("corporation"));
