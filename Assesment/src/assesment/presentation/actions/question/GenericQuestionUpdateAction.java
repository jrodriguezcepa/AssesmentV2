 ...
 */
public class GenericQuestionUpdateAction extends AbstractAction {
    ...
    public ActionForward action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        sys.getQuestionABMFacade().update(question,questionTexts,answerTexts,sys.getUserSessionData(),QuestionData.GENERIC);
