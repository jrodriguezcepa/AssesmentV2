...
public class GenericQuestionChangeOrderAction extends AbstractAction {
    ...
    public ActionForward action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        sys.getQuestionABMFacade().moveQuestion(questionDown,1,sys.getUserSessionData(),QuestionData.GENERIC);
        sys.getQuestionABMFacade().moveQuestion(questionUp,-1,sys.getUserSessionData(),QuestionData.GENERIC);
