...
public class GenericQuestionGroupAction extends AbstractAction {
    ...
    public ActionForward action(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        ModuleData module = sys.getModuleReportFacade().findGenericModule(moduleId,sys.getUserSessionData());
        ...
        sys.getQuestionABMFacade().updateGroups(changes,sys.getUserSessionData(),QuestionData.GENERIC);
