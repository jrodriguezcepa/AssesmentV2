...
public class VServlet
    ...
    protected void serveResource(HttpServletRequest request,
        ...
        try {
        	...
        	if(isProductionServer()) {
        		fileContext.setDocBase("/home/flash/assessment");
        	}else {
        		fileContext.setDocBase("C://flash//assessment");
        	}
        	Hashtable<String, String> env = new Hashtable<String, String>();
            env.put(ProxyDirContext.HOST, resources.getHostName());
            env.put(ProxyDirContext.CONTEXT, path);

            resources = new ProxyDirContext(env, fileContext);
        ...
        if ( (cacheEntry.context != null)
            ...
            if (content) {
                ...
                if (ostream != null) {
                    if (!super.checkSendfile(request, response, cacheEntry, contentLength, null))
    ...
    protected InputStream render(String contextPath, CacheEntry cacheEntry)
        ...
        InputStream xsltInputStream = (InputStream) super.findXsltInputStream(cacheEntry.context);
    ...
    protected void copy(CacheEntry cacheEntry, InputStream is, ServletOutputStream ostream)
        ...
        /*InputStream resourceInputStream = new FileInputStream("c:\\flash\\assessment\\videos\\video_42.mp4");
       ...
       // InputStream istream = new BufferedInputStream(resourceInputStream, input);
        //InputStream istream = new FileInputStream("c:\\flash\\assessment\\videos\\video_42.mp4");
