...
public class AlRiyadahSaveAnswersAction extends AbstractAction {
    ...
    public ActionForward action(ActionMapping mapping, ActionForm answers, HttpServletRequest request, HttpServletResponse response) throws Throwable {
        ...
        String login = answerData.getString("user");
        ...
        try {
            ...
            usABMFacade.associateAssesment(login, new Integer(assesmentId), userSessionData);
            ...
            if(message) {
                ...
                session.setAttribute("webinaruser", login);
