		        ...
		        <form name="accept" action="acceptPsiTerms.jsp" method="post">
		        	...
		        	<input type="hidden" name="type" value="1">
	         		<fieldset id="username_block" class="active">
						<h1><%=messages.getText("psi.terms.title") %></h1>
   						<div class="cleaner"></div>
	         			<div class="scroll">
    						<div class="scrollContainer">
							    <p><strong><%=messages.getText("psi.terms.instructions") %> </strong></p>
							    <p><%=messages.getText("psi.terms.text1") %> </p>
<%		for(int i = 1; i < 3; i++) {
%>								<p>
...
%>								</ul>
<%		}
%>							    <p><strong><%=messages.getText("psi.terms.text2") %> </strong></p>
			    				<ul>
 <%			for(int j = 1; j < 6; j++) {
%>   								<li><%=messages.getText("psi.terms.option"+j)%></li>
<%			}
%>								</ul>
							    <p><strong><%=messages.getText("psi.terms.text3") %> </strong></p>
            				</div>
            			</div>
       					<div class="cleaner"></div>
