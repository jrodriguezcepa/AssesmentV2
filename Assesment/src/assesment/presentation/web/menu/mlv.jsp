		...
		<html:form action="/CreateUserGroup">
			...
			<div class="container" style="width:100%;margin:0;padding:0;">
				<div class="col-xs-5"  style="background-color:#F5E64D; text-align:center;height:100%;">
					...
					<div class="col-xs-12" style="padding-top:40px;padding-left:30px;text-align:left;">
						<span style="font-family:proxima-nova,Verdana; font-size:3.2em; color:#333333; font-weight:bold;">
					...
					<div class="col-xs-12" style="padding-top:30px;padding-left:30px;text-align:left;">
						<span style="font-family:proxima-nova,Verdana; font-size:2.0em; color:#333333; font-weight:bold;">
					...
					<div class="col-xs-12" style="padding-top:30px;padding-left:30px;text-align:left;">
						<span style="font-family:proxima-nova,Verdana; font-size:2.0em; color:#333333; font-weight:bold;">
							<%=(lng.equals("es")) ? Util.formatHTML("Contamos con su participación,<br>es muy importante!") : Util.formatHTML("Contamos com a sua participação,<br>é muito importante!")%>
						</span>
					</div>
					<div class="col-xs-12" style="padding-top:40px; padding-left:30px;">
						<span style="font-family:proxima-nova, Verdana; font-size:1.5em; color:#333333; font-weight:bold;">
				...
				<div class="col-xs-7"  style="background-color:#FFFFFF; text-align:left;height:100%;">
					...
					<div class="col-xs-12" style="padding-top:10px; padding-left:30px; padding-left:30px;">
						<input type="text" name="company" placeholder='<%=(lng.equals("es")) ? "Compañía/MLP":"Companhia/MLP"%>' class="inputML" />
					</div>
<%			if(lng.equals("es")) {
%>					<div class="col-xs-12" style="padding-top:10px; padding-left:30px; padding-left:30px;">
...
%>					
					<div class="col-xs-12" style="padding-top:10px; padding-left:30px; padding-left:30px;">
						<input type="text" name="email" placeholder='<%=(lng.equals("es")) ? "Email (Usuario)":Util.formatHTML("Email (Usuário)")%>' class="inputML" />
					</div>
					<div class="col-xs-12" style="padding-top:10px; padding-left:30px; padding-left:30px;">
					...
					<div class="col-xs-12" style="padding-top:20px; padding-left:30px; padding-left:30px;">
						<span style="font-family:proxima-nova, Verdana; font-size:1.5em; color:#333333;">
							<p><b><%=(lng.equals("es")) ? Util.formatHTML("Características de la actividad:") : Util.formatHTML("Características da atividade:")%></b></p>
							<ul>
								<li><%=(lng.equals("es")) ? Util.formatHTML("Tiempo necesario para concluir la actividad: <b>12 minutos</b>.") : Util.formatHTML("Tempo necessário para concluir a atividade: <b>12 minutos</b>.")%></li>
								<li><%=(lng.equals("es")) ? Util.formatHTML("Luego de la actividad, usted recibirá un <b>informe y certificado</b> por email.") : Util.formatHTML("Após a atividade, você receberá um <b>relatório e certificado</b> por email.")%></li>
								<li><%=(lng.equals("es")) ? Util.formatHTML("Si usted no alcanza el mínimo necesario para emitir el certificado, <b>podrá ingresar nuevamente</b> con los mismos datos de usuario y contraseña.") : Util.formatHTML("Se você não atingir o mínimo necessário para emitir o certificado, <b>poderá ingressar novamente</b> com os mesmos dados de usuário e senha.")%></li>
							</ul>
						</span>
					</div>
					<div class="col-xs-12" style="padding-top:10px; padding-left:30px; padding-left:30px;">
