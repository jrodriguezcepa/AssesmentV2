...
<%
	...
	if(check!=null) {
        ...
        list3.add(new OptionItem("Artigas","1"));
        list3.add(new OptionItem("Canelones","2"));
        list3.add(new OptionItem("Cerro Largo","3"));
        list3.add(new OptionItem("Colonia","4"));
        list3.add(new OptionItem("Durazno","5"));
        list3.add(new OptionItem("Flores","6"));
        list3.add(new OptionItem("Florida","7"));
        list3.add(new OptionItem("Lavalleja","8"));
        list3.add(new OptionItem("Maldonado","9"));
        list3.add(new OptionItem("Montevideo","10"));
        list3.add(new OptionItem("Paysandú","11"));
        list3.add(new OptionItem("Río Negro","12"));
        list3.add(new OptionItem("Rivera","13"));
        list3.add(new OptionItem("Rocha","14"));
        list3.add(new OptionItem("Salto","15"));
        list3.add(new OptionItem(messages.getText("San José"),"16"));
        list3.add(new OptionItem("Soriano","17"));
        list3.add(new OptionItem("Tacuarembó","18"));
        list3.add(new OptionItem("Treinta y Tres","19"));
  ...
  <!-- **********************end JCalendar ********************************* -->
	...
	<body>
		<html:form action="/UserData" >
			...
			<table width="990" height="594" border="0" align="center" cellpadding="0" cellspacing="0"  class="tableaccesscodeDNB">
			  	<tr height="145">
			  		<td>&nbsp;</td>
			  	</tr>
			  	<tr>
    				<td align="center" valign="top">
    					<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" valign="top">
					      	<tr  class="userdataPepsico">
					        	<th align="left"> 
									Usuario (se recomienda usar letras min&uacute;sculas y n&uacute;meros sin espacios):
								</th>
        						<td align="right">
					      	...
					      	<tr  class="userdataPepsico">
        						<th align="left">
									Clave (se recomienda usar letras min&uacute;sculas y n&uacute;meros sin espacios):
								</th>
        						<td align="right">
					      	...
					      	<tr  class="userdataPepsico">
        						<th align="left">Apellido/s:</th>
        						<td align="right">
           							<html:text property="lastName" size="25" styleClass="inputPepsico"/>
          						</td>
      						</tr>
					      	<tr  class="userdataPepsico">
        						<th align="left" >Pa&iacute;s de nacimiento:</th>
        						<td align="right">
					      	...
					      	<tr  class="userdataPepsico">
        						<th align="left" >Antig&uuml;edad al servicio de la DNB:</th>
        						<td align="right">
					      	...
					      	<tr  class="userdataPepsico">
        						<th align="left" >Departamento en el que trabaja:</th>
        						<td align="right">
					      	...
					      	<tr  class="userdataPepsico">
        						...
        						<td align="right">
									<html:select property="sex" styleClass="inputPepsico" style="width:160; ">
										<html:option value="0"><%=messages.getText("generic.messages.select")%></html:option>
										<html:option value="1">ZyD</html:option>
										<html:option value="2">CCB</html:option>
										<html:option value="3">Subdirecci&oacute;n</html:option>
									</html:select>
      							</td>
							</tr>
					      	<tr  class="userdataPepsico">
        						<th align="left" >Destacamento:</th>
        						<td align="right">
			   						<html:text property="vehicle" size="25" styleClass="input"/>              
      							</td>
							</tr>
