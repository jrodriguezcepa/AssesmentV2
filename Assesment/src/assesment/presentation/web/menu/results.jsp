...
<%
	...
	boolean check = false;
	if(userSessionData.isAccessUser()) {
	
		Integer assessmentId = sys.getUserSessionData().getFilter().getAssessmentData().getId();
		String userLogin = userSessionData.getFilter().getLoginName();
					...
					<fieldset id="username_block" class="active">
						 <div class="titleReport" align="left">
						 	<div id="nameAssessment">
						 		<h1><%=messages.getText("generic.assesment")+": "+dataSource.getAssessment().getName()%></h1>
						 	</div>
