...
<%
	...
	if(check!=null) {
		...
		boolean isJJ = assesmentId == AssesmentData.JJ || assesmentId == AssesmentData.JJ_2
		|| assesmentId == AssesmentData.JJ_3 || assesmentId == AssesmentData.JJ_4 || assesmentId == AssesmentData.JJ_8; 
%>
<!-- *************************JCalendar***********************************-->
 <!-- calendar stylesheet -->
...
%>					      	<tr  class="userdata">
							...
							<tr  class="userdata">
								<th align="left" width="22%"><%=messages.getText("user.data.startdate")%></th>
								<td align="right" width="25%">
									<html:text property="startDay" style="width:20;" styleClass="input" styleId="dayStart" />/
					      	...
					      	<tr  class="userdata">
								<th align="left" width="22%"><%=messages.getText("user.data.expirydate")%></th>
								<td align="right" width="25%">
									<html:text property="expiryDay" style="width:20;" styleClass="input" styleId="dayExpiry" />/
	           						<html:text property="expiryMonth" style="width:20;" styleClass="input" styleId="monthExpiry" />/
	           						<html:text property="expiryYear" style="width:40;" styleClass="input" styleId="yearExpiry"/>
	           						<html:img page="/component/jscalendar-1.0/img.gif" styleId="calendar_buttonExpiry" style="cursor: pointer; border: 1px solid red;" onmouseover="this.style.background='red';" style="width:20;" align="middle" onmouseout="this.style.background=''"/>
	           						<script>
										Calendar.setup({
								        	inputArea     :    "yearExpiry",
								        	ifFormat       :    "%d/%m/%Y",
								        	showsTime      :    true,
								        	timeFormat     :    "24",
								        	button         :    "calendar_buttonExpiry",
								        	step           :    1,
					      	...
					      	<tr  class="userdata">
								<th align="left" width="22%"><%=messages.getText("user.data.vehicle")%></th>
								<td align="right" >
			   						<html:text property="vehicle" size="25" styleClass="input"/>              
								</td>
							</tr>
					      	<tr  class="userdata">
        						<th align="left" > <%=messages.getText("user.data.location")%><span class="required">*</span></th>
        						<td align="right">
					      	...
					      	<tr  class="userdata">
        						<th align="left" > <%=messages.getText("user.data.language")%><span class="required">*</span></th>
        						<td align="right">
