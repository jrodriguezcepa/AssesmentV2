  ...
  <!-- **********************end JCalendar ********************************* -->
	...
	<body>
		<html:form action="/UserData" >
			<html:hidden property="assesment" value='<%=String.valueOf(AssesmentData.IMESEVI)%>'/>
			...
			<table width="990" height="594" border="0" align="center" cellpadding="0" cellspacing="0"  class="tableaccesscodeImesevi">
			  	<tr height="125">
			  		<td>&nbsp;</td>
			  	</tr>
			  	<tr height="100">
			  	...
			  	<tr>
    				<td align="center" valign="top">
    					<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0" valign="top">
					      	...
					      	<tr class="userdataAnglo" height="25">
        						<th align="left" >Nombre:<span class="required">*</span></th>
        						<td align="right">
           							<html:text property="firstName" size="25" styleClass="inputPepsico"/>
          						</td>
      						</tr>
					      	<tr class="userdataAnglo" height="25">
        						<th align="left">Apellido:<span class="required">*</span></th>
        						<td align="right">
