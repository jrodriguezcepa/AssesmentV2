         	...
         	<section class="grid_container">
         		<form name="accept" action="acceptTerms.jsp" method="post">
	         		<fieldset id="username_block" class="active">
						<h1><%=(userSessionData.getLenguage().equals("pt")) ? messages.getText("webinar.title") : messages.getText("generic.terms.title")%></h1>
   						<div class="cleaner"></div>
	         			<div class="scroll">
    						<div class="scrollContainer">
    						
<%		if(userSessionData.getLenguage().equals("pt")) {
			for(int i = 1; i <= 6; i++) {
%>							    <p><%=messages.getText("webinar.terms.line"+i)%></p>
<%			}
		} else {
			for(int i = 1; i <= 5; i++) {
