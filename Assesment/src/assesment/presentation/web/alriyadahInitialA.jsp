...
<!-- Question 1  -->
			<div class="center2">
				...
				<div>
					<br><label> .1</label>
					<br><label> ترغب في الانعطاف يمينا إلى الأمام. لماذا يجب أن تأخذ الوضع الصحيح في الوقت المناسب؟</label>
				</div>
				<!-- Option 1 -->
				<div>
...
%>
	...
	<!-- Question 2  -->
			<div class="center2">
				...
				<div>
					<br><label> .2</label>
					<br><label> ما الذي يشترط القانون أن تبقيه في حالة جيدة؟</label>
				</div>
				<!-- Option 1 -->
				<div>
...
%>
	...
	<!-- Question 3  -->
			<div class="center2">
				...
				<div>
					<br><label> .3</label>
					<br><label> إشارات المرور التي تعطي الأوامر هي بشكل عام أي شكل</label>
				</div>
				<div>
...
%>					<div class="column">
						<label class="radio">
							<img style="width:40%;" src="images/1634-3-4.png" alt="cepa">
...
%>					<div class="column">
						<label class="radio">
							<img  style="width:40%;" src="images/1634-3-3.png" alt="cepa">
...
%>					<div class="column">
						<label class="radio">
							<img  style="width:40%;" src="images/1634-3-2.png" alt="cepa">
...
%>					<div class="column">
						<label class="radio">
							<img style="width:72%;margin-top:15px;" src="images/1634-3-1.png" alt="cepa">
...
%>				</div>
	...
	<!-- Question 4  -->
			<div class="center2">
				...
				<div>
					<br><label> .4</label>
					<br><label> ما هو ضوء التحذير الموجود في لوحة العدادات الذي يُظهر أن المصابيح   الأمامية في شعاع كامل؟</label>
				</div>
				<div>
				<div class="row">
...
%>					<div class="column">
						<label class="radio">
							<img style="width:50%;" src="images/1634-4-4.png" alt="cepa">
...
%>					<div class="column">
						<label class="radio">
							<img style="width:50%;" src="images/1634-4-3.png" alt="cepa">
...
%>					<div class="column">
						<label class="radio">
							<img style="width:50%;" src="images/1634-4-2.png" alt="cepa">
...
%>					<div class="column">
						<label class="radio">
							<img style="width:50%;" src="images/1634-4-2.png" alt="cepa">
							<input type="radio" name='51279'  value="1621"/>
						</label>
					</div>
<%				}  
%>				
...
%>					<div class="column">
						<label class="radio">
							<img  style="width:50%;" src="images/1634-4-1.png" alt="cepa">
...
%>
	...
	<!-- Question 5  -->
			<div class="center2">
				...
				<div>
					<br><label> .5</label>
					<br><label> ما هي الأضواء التي يجب أن تستخدمها أثناء القيادة في نفق؟</label>
				</div>
				<!-- Option 1 -->
				<div>
	...
	<!-- Question 5 ends -->
		<!-- Question 6  -->
			<div class="center2">
				...
				<div>
					<br><label> .6</label>
					<br><label style="float:left;"> أنت تتبع مركبة تتحرك ببطء على طريق ريفي ضيق. هناك   تقاطع أمامك على اليمين. ماذا عليك ان تفعل؟</label>
...
%>
	...
	<!-- Question 7  -->
		...
		<div>
			<br><label> .7</label>
			<br><label style="float:right";> أنت تقترب من إشارة مرور حمراء. ماذا ستظهر الإشارة بعد ذلك؟</label><br>
			<img style="float:left;margin-left:300px;width:10%;" src="images/1634-6.png" alt="cepa">
...
%>
	...
	<!-- Question 8  -->
		...
		<div>
			<br><label> .8</label>
			<br><label> كيف يمكنك استخدام محرك مركبتك للتحكم في سرعتك؟</label>
		</div>
		<!-- Option 1 -->
		<div>
