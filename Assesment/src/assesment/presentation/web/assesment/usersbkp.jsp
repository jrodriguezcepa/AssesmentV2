...
<script language="JavaScript">
	...
	function generateReport(valueL, report) {
		var form = document.forms['DownloadResultReportBKPForm'];
...
<%
	...
	if(check!=null) {
		...
		if(id != null){
			...
			Collection<AssessmentUserData> list = sys.getAssesmentReportFacade().getAssessmentUsersBKP(new Integer(id),sys.getUserSessionData());
	        Collections.sort((List<AssessmentUserData>)list);
%>

	<head/>
	<body>
		<html:form action="/DownloadResultBKP" target="_blank">
