...
<%	AssesmentAccess sys = (AssesmentAccess)session.getAttribute("AssesmentAccess");
	...
	UserData userData = report.findUserByPrimaryKey(userSessionData.getFilter().getLoginName(),userSessionData);
	HashMap<Integer, Date> map = report.getUserAssessmentStatus(userData.getLoginName(),userSessionData);
...
%>			            <a class="dropdown-item" href="logout.jsp"><%=messages.getText("generic.messages.logout") %></a>
    	...
    	<main class="container main-content">
	      	<section id="inicio" class="row bg-image" <%=(group.getImage() != null) ?  "style='background-image: url(./flash/images/"+group.getImage()+");'" : ""%>>
        		<div class="col text" style="margin-top: 50px; margin-left: 20px;">
 		  			<span style="font-size: 1.25em; color: #333333; font-weight: bold;"><%=messages.getText("generic.messages.welcome")+" "+userData.getFirstName()%></span>
				</div>
      		</section>
