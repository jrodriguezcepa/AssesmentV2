	...
	<body class="login">
		...
		<section id="content" style="padding-top: 50px;">
			<section class="grid_container">
				<html:form action="/UPM" style="padding-right: 0px;">
					<fieldset id="username_block" class="active">
						...
						<div>
							<div style="float: left; width: 250px;">
								<input type="button" class="button" value="<%=messages.getText("generic.messages.enter")%>" onclick="javascript:document.forms['CharlaUPMForm'].submit();"/>
							</div>
							<div>
