...
<html>
	...
	<body>
		<form name="error" method="post" action="./" >
			<table width="499"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  				...
  				<tr>
    				...
    				<td width="417">Usted ha salido del sistema</td>
  				...
  				<tr>
    				<td width="4" height="24"><div align="center"></div></td>
    				<td width="417">
    					Para volver a ingresar presione <a onClick="javascript:document.forms[0].submit()">aqui</a>
    				</td>
    				<td width="4"><div align="center"></div></td>
    				<td width="4"><div align="center"></div></td>
  				</tr>
