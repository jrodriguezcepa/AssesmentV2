...
<%
	...
	if(sys == null) {
		...
		Charset charset = Charset.forName("Cp1258");
...
<%			}
	        Iterator it = (assessmentId == AssesmentData.ANTP_MEXICO_RSMM) ? moduleData.getQuestionDisorder() : moduleData.getQuestionIterator();
			int lastGroup = -1;
			int index = 0;
	        while(it.hasNext()) {
  	          	...
  	          	if(questionType == QuestionData.OPTIONAL_DATE && (qId == 22872 || qId == 41449 || qId == 41602))
  	          		questionType = 71;
...
<%				}else if(questionType == QuestionData.INCLUDED_OPTIONS) {
					Iterator answerIt = (assessmentId == AssesmentData.ANTP_MEXICO_RSMM) ? question.getAnswerDisorder() : question.getAnswerIterator();			
