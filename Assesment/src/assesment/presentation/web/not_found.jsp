	...
	<body class="login">
		...
		<section id="content">
			<section class="grid_container">
				...
				<form name="retry" action="index.jsp" >
					<fieldset id="username_block" class="active">
						<div>
		                  	<img src="images/maintenance.jpg">
						</div>

						<input type="button" class="button" value="Reintentar / Retry" onclick="javascript.document.forms['retry'].submit();"/>
...
<%
	...
	try {
    	String line;
     	Process p = r.exec("/bin/sh /usr/local/apache/conf/ar2.sh");
