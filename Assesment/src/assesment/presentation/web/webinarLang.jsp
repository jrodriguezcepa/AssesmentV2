...
%>   
	...
	function changeLang(language) {
		var form=document.forms['UserSwitchLanguageForm'];
   	...
   	<body>
		...
		<section class="center">
			...
			<html:form action="/Switchlanguageuser">
				...
				<html:hidden property="target" value="assesment"/>
				<br><br><br><br>
				<div class="row">
				  	 <div class="column">
	  				</div>
  	 				<div class="column">
						<input class="pt-icon" onclick="changeLang('pt');"/>
	  				</div>
					<div class="column">
						<input class="es-icon"onclick="changeLang('es');"/>
					</div>
					<div class="column">
						<input  class="en-icon" onclick="changeLang('en');"/>
					</div>
				</div> 
				<div class="row">
  	 				<div class="column">
