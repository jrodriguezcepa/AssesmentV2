...
<html:html>
	...
	<body class="login">
		<form name="logout" action="./logoutVB.jsp" method="post"></form>
		<header style="height: 50px;">
		</header>		
		<section id="content" style="padding-top: 50px;">
			<section class="grid_container">
				<html:form action="/Veibras" style="padding-right: 0px;">
					<fieldset id="username_block" class="active">
						...
						<div>
		                  	<label for="accesscode"><%=messages.getText("generic.messages.insertcpf")%></label>
							<html:text property="code" />
						</div>
						<div>
		                  	<label for="accesscode"><%=messages.getText("veibras.email")%></label>
							<html:text property="email" />
						</div>
						<div>
							<div style="float: left; width: 250px;">
								<input type="button" class="button" value="<%=messages.getText("generic.messages.enter")%>" onclick="javascript:document.forms['VeibrasForm'].submit();" style="width: 200px;"/>
							</div>
							<div>
