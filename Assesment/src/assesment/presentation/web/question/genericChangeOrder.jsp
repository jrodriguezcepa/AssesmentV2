...
<%
	...
	if(check!=null) {
	    ...
	    session.setAttribute("url","module/genericChangeOrder.jsp");
...
<script type="text/javascript">
	...
	<body>
	<html:form action="/GenericQuestionChangeOrder" >
...
%>
    		...
    		<tr >
				<td colspan="3" align="right">
					<a href='<%="./layout.jsp?refer=/module/genericview.jsp?module="+String.valueOf(id)%>'>
