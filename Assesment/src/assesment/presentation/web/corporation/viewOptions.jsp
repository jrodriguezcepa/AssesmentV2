				...
				<td colspan="3" align="left">
					<table>
						<tr>
							...
							<td align="left"  class="texts">
								<a href="javascript:document.forms['assesment'].submit()" class="texts">
									<input type="button" class="button" value='<%=messages.getText("corporation.action.addassesment")%>' >
								</a>
							</td>
							<td align="left"  class="texts">
<%			String link = "javascript:confirmDelete(document.forms['CorporationDeleteForm'],'"+messages.getText("corporation.delete.confirm")+"')";
