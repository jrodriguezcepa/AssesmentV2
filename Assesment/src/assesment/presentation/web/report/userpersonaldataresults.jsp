...
<%
	...
	if(check!=null) {
		...
		if(!Util.empty(assesment)) {
		    elements = sys.getUserReportFacade().findAssesmentPDUsers(value,new Integer(assesment),sys.getUserSessionData());
		}
...
<form name="search" action="layout.jsp?refer=/report/userpersonaldataresults.jsp" method="post">
...
<body>
	<table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr class="guide1">
			<jsp:include  page='<%="../component/titlecomponent.jsp?title="+messages.getText("generic.user.personaldataresults")%>' />
  		</tr>
      	<tr>
  		...
  		<tr>
    		<td width="700" valign="top">
				...
				<html:form action="/UserPersonalDataResults">
						...
						<tr>
							<td colspan="2">
								<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
							  		<tr>
							    		<td valign="top">
											<jsp:include  page='<%="../component/utilityboxtop.jsp?title="+messages.getText("user.personaldata.done")%>' />
								    		<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td>
														<html:text property="value" size="30" styleClass="input" value='<%=value%>'/>
														<input name="button" type="button" onClick="javascript:searchUser(document.forms['UserPersonalDataResultForm'],document.forms['search']);" value='<%=messages.getText("generic.messages.search")%>' class="input"/>
													</td>
												</tr>
