...
<form name="search" action="layout.jsp?refer=/report/moduleresults.jsp" method="post">
...
<body>
	<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr class="guide1">
			<jsp:include  page='<%="../component/titlecomponent.jsp?title="+messages.getText("generic.data.moduleresults")%>' />
  		</tr>
      	<tr>
  		...
  		<tr>
    		<td width="700" valign="top">
				...
				<html:form action="/ModuleResults">
		    		<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td align="right">
								...
								<input name="button" type="button" onClick="javascript:searchQuestion(document.forms['ModuleResultReportForm'],document.forms['search']);" value='<%=messages.getText("generic.messages.search")%>' class="input"/>
							</td>
						</tr>
...
%>					    			        		<tr align=center class='<%=(lineone) ? "lineone" : "linetwo"%>'>
       													<td width="5%" align="center">
															<html:radio property="module" value='<%=String.valueOf(module.getId())%>' ></html:radio>                  
														</td>
					              						<td width="95%" align="left"><%=messages.getText(module.getKey())%></td>
							                		</tr>
<%				lineone = !lineone;
			}			 
		}else {		
