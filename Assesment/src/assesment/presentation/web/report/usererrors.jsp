...
<form name="search" action="layout.jsp?refer=/report/usererrors.jsp" method="post">
								    		...
								    		<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td>
														...
														<input name="button" type="button" onClick="javascript:searchUser(document.forms['UserErrorForm'],document.forms['search']);" value='<%=messages.getText("generic.messages.search")%>' class="input"/>
													</td>
												</tr>
